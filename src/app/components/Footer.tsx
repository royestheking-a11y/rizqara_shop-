...
import { Facebook, Instagram, MapPin, Phone, Mail, Package, ArrowUp, CheckCircle, Truck, Clock } from 'lucide-react';
    ...
    <footer className="bg-gray-900 text-white pt-16 pb-8">
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <div className="flex space-x-4">
              <a href="https://www.facebook.com/rizqarashop" target="_blank" rel="noopener noreferrer" className="hover:text-pink-500 transition"><Facebook size={20} /></a>
              <a href="https://www.instagram.com/rizqarashop/" target="_blank" rel="noopener noreferrer" className="hover:text-pink-500 transition"><Instagram size={20} /></a>
              <a href="https://www.pinterest.com/rizqarashop/" target="_blank" rel="noopener noreferrer" className="hover:text-pink-500 transition">
                <svg
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm text-gray-400">
              ...
              <li className="flex items-center gap-3">
                ...
                <span>+8801604710170</span>
              </li>
              <li className="flex items-center gap-3">
                <Mail size={18} className="shrink-0" />
                <span>rizqarashop@gmail.com</span>
              </li>
            </ul>
          </div>
        </div>
        ...
        <div className="border-t border-gray-800 mt-8 pt-8 flex flex-col md:flex-row justify-between items-center gap-4">
          <p className="text-sm text-gray-500 order-2 md:order-1">&copy; {new Date().getFullYear()} রিজকারা শপ। সর্বস্বত্ব সংরক্ষিত </p>
