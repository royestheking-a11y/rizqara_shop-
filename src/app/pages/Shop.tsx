  ...
  const getSeoData = () => {
    ...
    if (category === 'women') {
      return {
        ...
        url: `${import.meta.env.VITE_SITE_URL}/shop?cat=Women`
      };
    }
    if (category === 'gifts') {
      return {
        ...
        url: `${import.meta.env.VITE_SITE_URL}/shop?cat=Gifts`
      };
    }
    if (category === 'art') {
      return {
        ...
        url: `${import.meta.env.VITE_SITE_URL}/shop?cat=Art`
      };
    }
    if (category === 'custom') {
      return {
        ...
        url: `${import.meta.env.VITE_SITE_URL}/shop?cat=Custom`
      };
    }
    if (category === 'plants') {
      return {
        ...
        url: `${import.meta.env.VITE_SITE_URL}/shop?cat=Plants`
      };
    }
    if (category === 'clay') {
      return {
        ...
        url: `${import.meta.env.VITE_SITE_URL}/shop?cat=Clay`
      };
    }
    return {
      ...
      url: `${import.meta.env.VITE_SITE_URL}/shop`
    };
  };
